  ...
  <div id="main_content">
    <div id="menu_tab">
      ...
      <ul class="menu">
        ...
        <li class="divider"></li>
        <li><a href="#" class="nav6">contect us</a></li>
        <li class="divider"></li>
...
<div class="prod_price">                                            
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT [Title], [Price], [Proimage], [ProductID] FROM [product] WHERE ([Title] LIKE '%' + @Title + '%')">
        <SelectParameters>
            <asp:QueryStringParameter Name="Title" QueryStringField="query" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
...
<!-- end of main_container -->
  ...
  <div class="footer">
    ...
    <div class="right_footer"> <a href="home.aspx">home</a> <a href="#">about</a> <a href="http://www.free-css.com/">sitemap</a> <a href="Privacy Policy.aspx">Privacy Policy</a> 
        <a href="Search.aspx">contact us</a> </div>
