...
<img src="clog.jpg" align="center" class="style3"/>
                            <tr>
                                ...
                                <td class="style5">
                                    <asp:TextBox ID="txt_admin" runat="server" Width="151px"></asp:TextBox>
                                </td>
                                <td class="style1">
                                    &nbsp;</td>
    <br />
                            ...
                            <tr>
                                ...
                                <td class="style6">
                                    <asp:TextBox ID="txt_email" runat="server" TextMode="SingleLine" Width="151px"></asp:TextBox>
                                </td>
                                <td>
                                    &nbsp;</td>
                            </tr>
                        ...
                        <asp:Button ID="Button1" runat="server" BorderStyle="None" CssClass="style2" 
                            Height="49px" Text="Submit" Width="140px" />
                        <br />
