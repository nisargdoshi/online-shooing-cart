<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="Update_Product.aspx.vb" Inherits="Default6" %>
...
<tr><td>  
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
     ...
     &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp     <asp:TextBox ID="TextBox4" 
              ...
              Columns="50" BackColor="#999999"></asp:TextBox>
      ...
      <tr><td>
          <asp:Button ID="Button1" runat="server" Text="Update" BackColor="#999999" 
              BorderColor="#999999" />
