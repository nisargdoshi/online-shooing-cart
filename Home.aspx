<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Home.aspx.vb" Inherits="Default10" %>
...
<body>
  ...
  <div id="main_content">
    ...
    <asp:DataList ID="DataList1" runat="server" RepeatColumns="3" 
        RepeatDirection="Horizontal" Height="447px" Width="577px" 
         BorderColor="Black" >
        <ItemTemplate>
                <div class="prod_box">
        ...
        <div class="center_prod_box">
          ...
          <asp:Label ID="Label1" runat="server" Text='<%# bind("title") %>' CssClass="product_title"></asp:Label></div>
                                        <div class="product_img">
                                           <asp:ImageButton ID="btnimg" runat="server" Height="177px" Width="170px" 
                                                    ToolTip="display detail"
                                                    ImageUrl='<%# bind("Proimage") %>' 
                                                CommandArgument='<%# bind("ProductID") %>' PostBackUrl='<%#"Product_detail.aspx?pName="+Eval("ProductID") %>' />
                                               
                                         </div>
<div class="prod_price">                                            
                                            <asp:Label ID="lblPrice" runat="server" Text="Price :"></asp:Label>
                                            <asp:Label ID="lblbPrice" runat="server" Text='<%# bind("Price") %>' CssClass="price"></asp:Label>
                                         </div>
                                         </div>
        </ItemTemplate>
    </asp:DataList>
   ...
   <%-- <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ConnectionString="<%$ ConnectionStrings:dob %>" 
          ...
          SelectCommand="SELECT [Title], [Price], [Proimage], [ProductID] FROM [product]">
    </asp:SqlDataSource>--%>
        ...
        <table border="0" width="100%">
            <tr>
                <td>
                  <%--  <asp:Label ID="lbl1" runat="server" BackColor="Yellow" BorderColor="Yellow" 
                        Font-Bold="True" ForeColor="#FF3300"></asp:Label>--%>
                </td>
            </tr>
            <tr>
                <td>
                    <center><asp:Button ID="btnPrevious" runat="server"  
                        text="Previous" Width="60px" onclick="btnPrevious_Click"  />
                    &nbsp;&nbsp;
                    <asp:Button ID="btnNext" runat="server"  text="Next" 
                        Width="60px"   onclick="btnNext_Click" ClientIDMode="AutoID" Enabled="False"/></center>
                </td>
            </tr>
        </table>
