  ...
  <div id="main_content">
    <div id="menu_tab">
      ...
      <ul class="menu">
        ...
        <li class="divider"></li>
        <li><a href="#" class="nav6">
            <asp:LinkButton ID="LinkButton1" runat="server">Logout</asp:LinkButton></a></li>
        <li class="divider"></li>
    ...
    <div>
           <div>About us</div>
     <p>
     Anjali Computer Media Company is inCenter of Rajkot city.</br>
     We would like to take the opportunity to represent ourselves as an Authorized supplier of Computer consumables particularly Laser printer cartridge, Inkjet printer cartridge and ribbon cartridge, Data storage media CD, Data cartridges, Computer Accessories Computer files, Paper, Computer Cover, CD storage Computer Peripherals Mouse, Keyboard, TFT, Laser / Dot-matrix Printer, Pen drive, USB Hard disk, DVD Writer, Laptop spares, battery, power adopter etc.</br>
     Anjali Computer Media would like to take the opportunity to represent ourselves as an authorized.</br>
     Anjali Computer Media are authorized representative of many giant companies thru whom we are sourcing genuine materials.</br>
     You will find all the products from these companies are of best quality and at cost effective prices.</br> 
     Company believes to supply genuine products of best quality and at economical rates on time.
     </p>
   </div>
